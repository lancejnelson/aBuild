...
#        self.potential = potential
    ...
    def buildFolder(self,runGetKPoints = True):
        ...
        settings["lVs"] = self.crystal.lattice_lines_LAMMPS
        settings["bVs"] = self.crystal.basis_lines_LAMMPS
        settings["basis"] = self.crystal.unknown
        settings["potential"] = self.potential
        settings["species"] = ' '.join(self.crystal.species)
